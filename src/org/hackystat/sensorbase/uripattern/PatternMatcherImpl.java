/*
 * Modified by Qin Zhang, originally from Ant source code.
 * Modifications:
 *   (1) class package and class name changed.
 *   (2) one method is commented out.
 *   (3) class access right changed from public to package private.
 */
...
/**
 * <p><b>For package internal use only. Copied from Ant 1.6.</b></p>
 *
 ...
 * @version Ant 1.6
 */
final class PatternMatcherImpl {
...
//    }
    ...
    //check style is too stupid, compains, modify to please it.
    boolean theResult;
    if (strIdxStart > strIdxEnd) {
      theResult = true;
    }
  ...
  public static boolean matchPath(String pattern, String str, boolean isCaseSensitive) {
    // I DON'T THINK THIS APPLIES TO HACKYSTAT 8 (pmj 6/2007)
    // When str starts with a File.separator, pattern has to start with a
    // File.separator.
    // When pattern starts with a File.separator, str has to start with a
    // File.separator.
